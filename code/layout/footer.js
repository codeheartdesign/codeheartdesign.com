 ...
 */
const Footer = ({ _body }) => (
	<footer role="banner" className="wrapper gridgap">
		<div className="footer-logo">
			<div className="footer-logo-wrapper">
				<svg className="heart heart-logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 392 60">
					<title>Code Heart Design logo</title>
		...
		<div className="footer-body">{ _body }</div>

		<div className="footer-gem">
			<svg className="heart heart-gem" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 69 69" version="1">
				<g fill="none" fillRule="evenodd">
